    ...
    <>
      ...
      <main>
        ...
        <FlexBox dir="column" height="fit-content">
          <Image src="/Cocktails2.png" style={{minHeight:"170px", width:"105vw"}} position="absolute" top="900px"></Image>
          <Image src="/Table.jpeg" style={{maxHeight:"100px", width:"100vw"}}></Image>
        </FlexBox>
