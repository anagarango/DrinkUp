    ...
    <>
      ...
      <main>
        ...
        <FlexBox dir="column" bgColor="#590067" padding="40px 0" width="100vw">
          ...
          <FlexBox bgColor="rgba(0, 0, 0, 0.8)" width="85vw" maxWidth="830px" padding="35px" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #00C5CC, 0px 0px 4px 10px rgba(0, 247, 254, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #00C5CC, inset 0px 0px 4px 10px rgba(0, 247, 254, 0.18)" dir="column">
          ...
          <FlexBox bgColor="rgba(0, 0, 0, 0.8)" width="85vw" maxWidth="830px" padding="35px" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #05D005, 0px 0px 4px 10px rgba(5, 208, 5, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #05D005, inset 0px 0px 4px 10px rgba(5, 208, 5, 0.18)" dir="column">
            <Heading textShadow="0 0 0.01em #fff, 0 0 0.015em #fff, 0 0 0.02em #fff, 0 0 0.02em rgb(84, 213, 84),0 0 0.1em rgb(5, 208, 5), 0 0 0.15em rgb(5, 208, 5), 0 0 0.45em rgb(5, 208, 5), 0 0 0.12em" padding="0 0 25px 0">Categories</Heading>
            <FlexBox flexWrap="wrap">
            {listOfCategories.map((o)=>(
              <Button txt={o} bgColor={category == o ? "white" : "black"} color={category == o ? "black" : "white"} onClick={()=>{setCategory(o)}} height="fit-content" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #05D005, 0px 0px 4px 10px rgba(5, 208, 5, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #05D005, inset 0px 0px 4px 10px rgba(5, 208, 5, 0.18)" padding="15px" top="200px" dir="column"/>
            ))}
            </FlexBox>
          </FlexBox>
