  ...
  return (
    <>
      ...
      <main>
        ...
        <Image bgImage="/Hero.jpeg" minHeight="300px" height="400px"></Image>
        <Image bgImage="/SecondHero.jpeg" minHeight="650px" height="400px"></Image>
        <Image bgSize="cover" bgImage="/Table.jpeg" minHeight="50px" height="60px">
          <img src="/Cocktails2.png" style={{minHeight:"170px", height:"100%", maxHeight:"460px"}}></img>
          <Image bgSize="cover" position="relative" bgImage="/Cocktails2.png" minHeight="170px" height="100%" maxHeight="460px" top="calc(1110px)" zIndex="100" left="0px" margin="-460px 0 0 0"></Image>
        </Image>
        
        <h1 style={{fontWeight:200, fontSize:"60px"}} className="neon">Welcome to DrinkUp</h1>
      <FlexBox>
