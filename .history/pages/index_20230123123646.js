    ...
    <>
      ...
      <FlexBox>
          {listOfIngredients.map((o)=>(
            <Button bgColor={ingredients == o ? "red" : "orange"} padding="5px" margin="0px 10px" onClick={()=>{setIngredients(o)}}>
              {o}
            </Button>
          ))}
        </FlexBox>
        ...
        <FlexBox bgColor="rgba(0, 0, 0, 0.8)" padding="35px" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #00C5CC, 0px 0px 4px 10px rgba(0, 247, 254, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #00C5CC, inset 0px 0px 4px 10px rgba(0, 247, 254, 0.18)" dir="column">
          ...
          {listOfCategories.map((o)=>(
            <Button txt={o} bgColor={category == o ? "white" : "black"} color={category == o ? "black" : "white"} borderRpadding="5px" margin="0px 10px" onClick={()=>{setCategory(o)}} height="fit-content" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #08F7FE, 0px 0px 4px 10px rgba(0, 247, 254, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #08F7FE, inset 0px 0px 4px 10px rgba(0, 247, 254, 0.18)" padding="15px" top="200px" dir="column"/>
          ))}
          </FlexBox>
        </FlexBox>
