  ...
  return (
    <>
      ...
      <main className={styles.main}>
        <div>
          <input type="radio" id="html" name="Cocktail" value="Cocktail" onClick={(event)=>setCategory(event.target.value)}/>
          <label for="Cocktail">Cocktail</label>
          <input type="radio" id="hello" name="Ordinary Drink" value="Ordinary Drink" onClick={(event)=>setCategory(event.target.value)} />
