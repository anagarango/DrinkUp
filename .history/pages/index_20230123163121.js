  ...
  return (
    <>
      ...
      <main>
        ...
        {/* <NavBar></NavBar> */}
        <FlexBox height="fit-content" width="85vw" maxWidth="830px" position="absolute" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #D255C6, 0px 0px 4px 10px rgba(210, 85, 198, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #D255C6, inset 0px 0px 4px 10px rgba(210, 85, 198, 0.18)" padding="35px" top="200px" dir="column" bgColor="rgba(0, 0, 0, 0.8)">
        ...
        <FlexBox dir="column" bgColor="#590067" padding="40px 0" width="100vw">
          <FlexBox borderRadius="10px" bgColor="rgba(0, 0, 0, 0.8)" width="85vw" maxWidth="830px" padding="35px" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #E97227, 0px 0px 4px 10px rgba(233, 114, 39, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #E97227, inset 0px 0px 4px 10px rgba(233, 114, 39, 0.18)" dir="column" margin="0 0 40px 0">
            ...
            {listOfIngredients.map((o)=>(
              <Button borderRadius="10px" txt={o} bgColor={category == o ? "white" : "black"} color={category == o ? "black" : "white"} onClick={()=>{setCategory(o)}} height="fit-content" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #E97227, 0px 0px 4px 10px rgba(233, 114, 39, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #E97227, inset 0px 0px 4px 10px rgba(233, 114, 39, 0.18)" padding="15px" top="200px" dir="column"/>
            ))}
            </FlexBox>
          </FlexBox>

          <FlexBox borderRadius="10px" bgColor="rgba(0, 0, 0, 0.8)" width="85vw" maxWidth="830px" padding="35px" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #00C5CC, 0px 0px 4px 10px rgba(0, 247, 254, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #00C5CC, inset 0px 0px 4px 10px rgba(0, 247, 254, 0.18)" dir="column">
            ...
            {listOfCategories.map((o)=>(
              <Button borderRadius="10px" txt={o} bgColor={category == o ? "white" : "black"} color={category == o ? "black" : "white"} onClick={()=>{setCategory(o)}} height="fit-content" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #08F7FE, 0px 0px 4px 10px rgba(0, 247, 254, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #08F7FE, inset 0px 0px 4px 10px rgba(0, 247, 254, 0.18)" padding="15px" top="200px" dir="column"/>
            ))}
            </FlexBox>
          </FlexBox>
