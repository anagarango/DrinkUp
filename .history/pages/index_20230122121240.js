  ...
  return (
    <>
      ...
      <main>
        ...
        <FlexBox width="80vw" maxWidth="400px" position="absolute" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #D255C6, 0px 0px 4px 10px rgba(210, 85, 198, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #D255C6, inset 0px 0px 4px 10px rgba(210, 85, 198, 0.18)" padding="20px" top="200px" dir="column" bgColor="rgba(0, 0, 0, 0.75);">
            <Heading>Welcome to DrinkUp</Heading>
            <Paragraph>Simplifying your Cocktail Preferences</Paragraph>
            <Paragraph>DrinkUp, a pain-point that became a project, is inspired to help new-legal aged people to find their favourite cocktails to order in their next pub, bar, and/or nightclub visit. Drink Responsibly!</Paragraph>
        </FlexBox>
