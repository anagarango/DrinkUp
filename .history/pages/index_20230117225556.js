  ...
  return (
    <>
      ...
      <main className={styles.main}>
        <div>
           <input type="radio" id="css" name="Cocktail" value="Cocktail" onClick={(event)=>setCategory(event.target.value)}/>
           <label for="Cocktail">Cocktail</label>
           <input type="radio" id="javascript" name="fav_language" value="JavaScript" onClick={(event)=>setCategory(event.target.value)}/>
