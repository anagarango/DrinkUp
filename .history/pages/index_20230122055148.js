    ...
    <>
      ...
      <main>
        ...
        <FlexBox dir="column" height="fit-content" justifyContent="flex-end">
          ...
          <FlexBox position="absolute" dir="column" minHeight="30vh" height="75vh" width="100vw" margin="-5px 0 0 0">
            <Image src="/Table.jpeg" style={{maxHeight:"85px", width:"100vw"}} position="relative" bottom="0px"></Image>
