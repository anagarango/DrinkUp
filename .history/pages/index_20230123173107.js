...
export default function Home() {
  ...
  useEffect(() => {
    ...
    document.querySelector("main").onscroll = (e) => console.log(e.target.documentElement.scrollTop)
  }, [])
  ...
  return (
    <>
      ...
      <main>
        ...
        <FlexBox bgImage="/SecondHero.jpeg" minHeight="75vh" maxHeight="80vh" width="100vw" dir="column" justifyContent="flex-end">
