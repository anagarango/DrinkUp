    ...
    <>
      ...
      <main>
        ...
        <FlexBox dir="column" bgColor="#590067" padding="40px 0" width="100vw">
          <FlexBox bgColor="rgba(0, 0, 0, 0.8)" width="85vw" maxWidth="830px" padding="35px" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #E97227, 0px 0px 4px 10px rgba(233, 114, 39, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #E97227, inset 0px 0px 4px 10px rgba(233, 114, 39, 0.18)" dir="column">
            ...
            <FlexBox flexWrap="wrap" margin="0 0 40px 0">
            {listOfIngredients.map((o)=>(
              <Button txt={o} bgColor={category == o ? "white" : "black"} color={category == o ? "black" : "white"} onClick={()=>{setCategory(o)}} height="fit-content" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #E97227, 0px 0px 4px 10px rgba(233, 114, 39, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #E97227, inset 0px 0px 4px 10px rgba(233, 114, 39, 0.18)" padding="15px" top="200px" dir="column"/>
            ))}
            </FlexBox>
          </FlexBox>
