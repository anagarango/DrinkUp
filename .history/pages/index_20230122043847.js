  ...
  return (
    <>
      ...
      <main>
        ...
        <Image position="absolute" bgImage="/Cocktails2.png" minHeight="160px" height="400px" maxHeight="500px" top="100px" zIndex="100" left="0px"></Image>
        <Image position="relative" bgImage="/Hero.jpeg" minHeight="300px" height="400px"></Image>
