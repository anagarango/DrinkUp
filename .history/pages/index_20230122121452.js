  ...
  return (
    <>
      ...
      <main>
        ...
        <FlexBox width="80vw" maxWidth="830px" position="absolute" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #D255C6, 0px 0px 4px 10px rgba(210, 85, 198, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #D255C6, inset 0px 0px 4px 10px rgba(210, 85, 198, 0.18)" padding="35px" top="200px" dir="column" bgColor="rgba(0, 0, 0, 0.75);">
