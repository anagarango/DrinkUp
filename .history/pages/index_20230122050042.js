  ...
  return (
    <>
      ...
      <main>
        ...
        <Image bgSize="cover" position="relative" bgImage="/Cocktails2.png" minHeight="170px" height="100%" maxHeight="760px" top="calc(1010px)" zIndex="100" left="0px" margin="-460px 0 0 0"></Image>
