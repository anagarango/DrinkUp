  ...
  return (
    <>
      ...
      <main className={styles.main}>
        <div>
           <input type="radio" id="css" name="category" value="Cocktail" onClick={(event)=>setCategory(event.target.value)}/>
           <label for="Cocktail">Cocktail</label>
           <input type="radio" id="javascript" name="category" value="JavaScript" onClick={(event)=>setCategory(event.target.value)}/>
