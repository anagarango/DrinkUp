  ...
  return (
    <>
      ...
      <main>
        ...
        <Image bgSize="contain" position="relative" bgImage="/Cocktails2.png" minHeight="160px" height="300px" maxHeight="500px" top="100px" zIndex="100" left="0px" margin="-300px 0 0 0"></Image>
        ...
        <Image bgSize="contain" bgImage="/Table.jpeg" minHeight="50px" height="150px"></Image>
