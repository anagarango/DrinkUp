  ...
  return (
    <>
      ...
      <main>
        ...
        <FlexBox position="absolute" height="fit-content" flexDir="column">
          <Image bgSize="contain" position="relative" bgImage="/Cocktails2.png" minHeight="170px" height="100vw" maxHeight="460px" top="calc(1110px)" zIndex="100" left="0px" margin="-460px 0 0 0"></Image>
          <Image bgImage="/SecondHero.jpeg" minHeight="650px" height="400px"></Image>
          
        </FlexBox>
        <Image bgSize="cover" bgImage="/Table.jpeg" minHeight="50px" height="60px"></Image>
