    ...
    <>
      ...
      <main>
        ...
        <FlexBox dir="column" height="fit-content">
          <Image src="/Cocktails2.png" style={{width:"105vw"}} position="relative" top="900px"></Image>
          <Image src="/Table.jpeg" style={{maxHeight:"85px", width:"100vw"}} position="absolute"></Image>
        </FlexBox>
