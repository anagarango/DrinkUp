  ...
  return (
    <>
      ...
      <main className={styles.main}>
        <div>
            <input type="radio" value="Cocktail" onClick={(event)=>setCategory(event.target.value)} />
            <label for="Cocktail">Cocktail</label>
            <input type="radio" value="Ordinary Drink" onClick={(event)=>setCategory(event.target.value)} />
