  ...
  return (
    <>
      ...
      <main>
        ...
        <Image src="/Hero.jpeg" minHeight="450px" maxHeight="55px0" height="100%" width="100vw"></Image>
        <Image src="/SecondHero.jpeg" minHeight="400px" height="100%" width="100vw" margin="-5px 0 0 0"></Image>
        <FlexBox flexDir="column">
          <img src="/Cocktails2.png" style={{minHeight:"170px", width:"100vw"}}></img>
          <img src="/Table.jpeg" style={{minHeight:"50px", width:"100vw"}}></img>
        </FlexBox>
