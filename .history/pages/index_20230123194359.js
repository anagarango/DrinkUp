      ...
      <main>
        ...
        <FlexBox bgImage="/Hero.jpeg" minHeight="fit-content" height="65vh" width="100vw" margin="70px 0 0 0">
          <FlexBox height="fit-content" width="85vw" maxWidth="830px" boxShadow="0px 0px 3px 4px #FFFFFF, 0px 0px 11px 5px #D255C6, 0px 0px 4px 10px rgba(210, 85, 198, 0.18), inset 0px 0px 4px 3px #FFFFFF, inset 0px 0px 11px 5px #D255C6, inset 0px 0px 4px 10px rgba(210, 85, 198, 0.18)" padding="35px" top="200px" dir="column" bgColor="rgba(0, 0, 0, 0.8)">
            <Heading fSize="calc(30px + 55%)">Welcome to DrinkUp</Heading>
            <Paragraph textAlign="justify" padding="10px 0 0 0">Simplifying your Cocktail Preferences</Paragraph>
            <span id="height"></span>
        ...
        <FlexBox bgImage="/SecondHero.jpeg" minHeight="400px" height="50vw" width="100vw" dir="column" justifyContent="flex-end">
          <Heading fSize="calc(30px + 55%)">Feel Good About What You Drink</Heading>
