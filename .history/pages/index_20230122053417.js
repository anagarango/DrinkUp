    ...
    <>
      ...
      <main>
        ...
        <FlexBox dir="column" height="fit-content">
          <Image src="/Cocktails2.png" style={{minHeight:"170px", width:"100vw"}} position="absolute" bottom="200px"></Image>
          <Image src="/Table.jpeg" style={{minHeight:"50px", width:"100vw"}}></Image>
        </FlexBox>
