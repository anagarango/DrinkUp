...
export default function Home() {
  ...
  function setCurrentCategory(chosenCategory){
      ...
      <button onClick={()=>GetCocktail()}>Get a Cocktail</button>
        <FlexBox>
          {listOfCategories.map((o)=>(
            <FlexBox bgColor={bgColor || "orange"} padding="5px" margin="0px 10px" onClick={()=>{setCategory(o)}} onChange={(e)=>{setCurrentCategory(e.target.value)}}>
              {o}
            </FlexBox>
          ))}
