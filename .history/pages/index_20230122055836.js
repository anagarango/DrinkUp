    ...
    <>
      ...
      <main>
        ...
        <FlexBox dir="column" height="fit-content" justifyContent="flex-end">
          <Image src="/SecondHero.jpeg" minHeight="30vh" height="80vh" width="100vw" margin="-5px 0 0 0" bgPosition="50% 15%"></Image>
          <FlexBox position="absolute" dir="column">
            <Image src="/Cocktails2.png" style={{width:"100vw"}} position="relative" bottom="calc(-60px - 3vh)"></Image>
