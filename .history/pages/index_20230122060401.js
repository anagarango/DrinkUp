      ...
      <main>
        ...
        <FlexBox dir="column" height="fit-content" justifyContent="flex-end">
          ...
          <FlexBox position="absolute" dir="column">
            <Image src="/Cocktails2.png" style={{width:"100vw"}} position="relative" bottom="calc(-5.3em)"></Image>
            <Image src="/Table.jpeg" style={{maxHeight:"85px", width:"100vw"}} position="relative" bottom="calc(-5.3em)"></Image>
          </FlexBox>
