...
export const Heading = styled.h1`
    ...
    cursor:${props=>props.cursor};
    text-shadow:${props=>props.textShadow || "0 0 0.01em #fff, 0 0 0.02em #fff, 0 0 0.03em #fff, 0 0 0.08em rgb(176, 119, 255),0 0 0.8em rgb(123, 0, 255), 0 0 0.12em rgb(123, 0, 255), 0 0 0.35em rgb(123, 0, 255), 0 0 0.12em rgb(123, 0, 255)"};
    color:white
  `