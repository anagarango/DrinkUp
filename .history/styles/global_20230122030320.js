...
export const Heading = styled.h1`
    ...
    cursor:${props=>props.cursor};
    text-shadow:${props=>props.textShadow || "0 0 0.05em #fff, 0 0 0.06em #fff, 0 0 0.07em #fff, 0 0 0.08em rgb(176, 119, 255),0 0 0.09em rgb(123, 0, 255), 0 0 0.10em rgb(123, 0, 255), 0 0 0.11em rgb(123, 0, 255), 0 0 0.12em rgb(123, 0, 255)"};
    color:white
  `