...
export const Heading = styled.h1`
    ...
    cursor:${props=>props.cursor};
    text-shadow:${props=>props.textShadow || "0 0 0.01em #fff, 0 0 0.015em #fff, 0 0 0.02em #fff, 0 0 0.02em rgb(176, 119, 255),0 0 0.1em rgb(123, 0, 255), 0 0 0.12em rgb(123, 0, 255), 0 0 0.35em rgb(123, 0, 255), 0 0 0.12em rgba(123, 0, 255,0.2)"};
    color:white
  `