...
export const Heading = styled.h1`
    ...
    cursor:${props=>props.cursor};
    text-shadow:${props=>props.textShadow || "0 0 0.03em #fff, 0 0 0.04em #fff, 0 0 0.05em #fff, 0 0 0.06em rgb(176, 119, 255),0 0 0.07em rgb(123, 0, 255), 0 0 0.8em rgb(123, 0, 255), 0 0 0.09em rgb(123, 0, 255), 0 0 0.10em rgb(123, 0, 255)"};
    color:white
  `