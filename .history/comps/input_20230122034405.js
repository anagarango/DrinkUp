...
export default function Input({
    ...
    return(
        <FlexBox width={width} height={height} boxShadow={boxShadow} border={border} backgroundColor={bgColor}>
            <input onChange={onChange} onKeyDown={onKeyDown} type={type} placeholder={placeholder} style={{backgroundColor:"rgba(0, 0, 0, 0)", width:"calc(85%)", fontFamily: "Montserrat", fontSize:"13px", color:"white"}}></input>
        </FlexBox>
