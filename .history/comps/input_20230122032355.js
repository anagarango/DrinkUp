...
export default function Input({
    ...
    return(
        <input className="input" type={type} placeholder={placeholder} style={{width:{width}, height:{height}, boxShadow:{boxShadow}, border:{border}, backgroundColor:{bgColor}, height:{height}}} ></input>
    )
}