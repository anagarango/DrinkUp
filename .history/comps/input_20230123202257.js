...
export default function Input({
    ...
    placeholder = "Search",
    width = "calc(100px + 10%)",
    boxShadow = "0px 0px 2px 4px #FFFFFF, 0px 0px 10px 4px #D255C6, 0px 0px 3px 9px rgba(210, 85, 198, 0.18), inset 0px 0px 3px 2px #FFFFFF, inset 0px 0px 10px 4px #D255C6, inset 0px 0px 3px 9px rgba(210, 85, 198, 0.18)",
