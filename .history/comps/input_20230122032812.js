...
export default function Input({
    ...
    return(
        <FlexBox width={width} height={height} boxShadow={boxShadow} border={border} backgroundColor={bgColor} height={height}>
            <input type={type} placeholder={placeholder} style={{backgroundColor:"black", width:"100%"}} ></input>
        </FlexBox>
