...
export default function Input({
    ...
    return(
        <FlexBox width={width} height={height} boxShadow={boxShadow} border={border} backgroundColor={bgColor}>
            <input value={value} onChange={onChange} onKeyDown={onKeyDown} type={type} placeholder={placeholder} style={{backgroundColor:"rgba(0, 0, 0, 0)", width:"calc(85%)", fontFamily: "Montserrat", fontSize:"15px", color:"white", border:"0px"}}></input>
        </FlexBox>
